        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                universidad.nit.isEmpty ? 'Sin nit' : universidad.nit,
                style: TextStyle(
                  fontSize: 13,
                  color: universidad.nit.isEmpty
                      ? colorScheme.onSurfaceVariant.withValues(alpha: 0.5)
                      : colorScheme.onSurfaceVariant,
                  fontStyle: universidad.nit.isEmpty
                      ? FontStyle.italic
                      : FontStyle.normal,
                ),
                maxLines: 2,
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 13,
                  color: universidad.paginaWeb.isEmpty
                      ? colorScheme.onSurfaceVariant.withValues(alpha: 0.5)
                      : colorScheme.onSurfaceVariant,
                  fontStyle: universidad.paginaWeb.isEmpty
                      ? FontStyle.italic
                      : FontStyle.normal,
                ),
                maxLines: 2,
